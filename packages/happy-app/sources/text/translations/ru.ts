...
export const ru: TranslationStructure = {
    ...
    server: {
        ...
        servers: 'Серверы',
        connectedServers: 'Подключённые серверы',
        noServersRegistered: 'Нет зарегистрированных серверов',
        addServer: 'Добавить сервер',
        removeServer: 'Удалить сервер',
        removeServerConfirm: 'Вы уверены, что хотите отключиться от этого сервера? Сессии и машины с этого сервера будут удалены.',
    ...
    terminal: {
        ...
        newServerNotice: 'Этот терминал находится на новом сервере. Принятие добавит этот сервер к вашим подключённым серверам.',
